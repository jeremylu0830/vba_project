...
Sub startMain()
    ...
    k = 1
        For Row = 1 To 23
            For Column = 1 To 23
                If wsH.Cells(Row, Column) = 0 Or wsH.Cells(Row, Column) = 6 Then
                    picturePath = ThisWorkbook.path & "\PictureInput\Ground.png" 'copy paste the floor picture to the 0 ,6 place
                    
                    Set targetCell = ws.Cells(Row, Column)
                    pictureName = "market-floor" & k
                    picset picturePath, targetCell, pictureName, 0, ws
                ElseIf wsH.Cells(Row, Column) = 1 Then
                    picturePath = ThisWorkbook.path & "\PictureInput\Wall_F.png" 'copy paste the wall picture to the 1 place
                    Set targetCell = ws.Cells(Row, Column)
                    'wsH.Cells(1, 1) = picturePath
                    pictureName = "market-wall" & k
                    picset picturePath, targetCell, pictureName, 0, ws
                    k = k + 1
                ElseIf wsH.Cells(Row, Column) = 3 Then
                    picturePath = ThisWorkbook.path & "\PictureInput\Shelves.png" 'copy paste the shelf picture to the 3 place
                    Set targetCell = ws.Cells(Row, Column)
                    pictureName = "market-shelf" & k
                    picset picturePath, targetCell, pictureName, 0, ws
                    k = k + 1
                ElseIf wsH.Cells(Row, Column) = 4 Then
                    picturePath = ThisWorkbook.path & "\PictureInput\Closing.png" 'copy paste the door picture to the 4 place
                    Set targetCell = ws.Cells(Row, Column)
                    pictureName = "market-door" & k
                    picset picturePath, targetCell, pictureName, 0, ws
                    k = k + 1
                ElseIf wsH.Cells(Row, Column) = 7 Then
                    picturePath = ThisWorkbook.path & "\PictureInput\Door.png" 'copy paste the entrance door picture to the 7 place
                    Set targetCell = ws.Cells(Row, Column)
                    pictureName = "entrance" & k
                    picset picturePath, targetCell, pictureName, 0, ws
                    k = k + 1
                ElseIf wsH.Cells(Row, Column) = 8 Then
                    picturePath = ThisWorkbook.path & "\PictureInput\PoS.png" 'copy paste the cashier picture to the 8 place
                    Set targetCell = ws.Cells(Row, Column)
                    pictureName = "cashier" & k
                    picset picturePath, targetCell, pictureName, 0, ws
                    k = k + 1
                ElseIf wsH.Cells(Row, Column) = 9 Then
                    picturePath = ThisWorkbook.path & "\PictureInput\Opening.png" 'copy paste the open picture to the 9 place
                    Set targetCell = ws.Cells(Row, Column)
                    pictureName = "open" & k
                    picset picturePath, targetCell, pictureName, 0, ws
                    k = k + 1

...
Sub RandomSelectCellWithNumbers()
    ...
    Randomize
    Max = Int(cellsWithNumbers.Count * Rnd) + 2
    ...
    Do While Max <> 0
        ...
        ouo.Cells(28, 1).CurrentRegion.ClearContents
        
        If Max <> 1 Then
            Randomize
            buy_quatity = Int(Sheets("HidemarketQuantity").Cells(itemrow, itemcol) * Rnd) + 1
            Sheets("HidemarketQuantity").Cells(itemrow, itemcol) = Sheets("HidemarketQuantity").Cells(itemrow, itemcol) - buy_quatity
            
            If Sheets("HidemarketQuantity").Cells(itemrow, itemcol) = 0 Then
                Sheets("HidemarketQuantity").Cells(itemrow, itemcol) = ""
                Sheets("HidemarketPrice").Cells(itemrow, itemcol) = ""
                Sheets("goodCust").Cells(itemrow, itemcol) = ""
            End If
            
            ouo.Cells(29, Item) = buy_quatity
